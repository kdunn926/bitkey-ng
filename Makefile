...
COMMON_CONF = turnkey.d/confconsole-autorun turnkey.d/console-setup turnkey.d/cronapt turnkey.d/dpkg-vendor turnkey.d/etckeeper turnkey.d/git-config turnkey.d/grub-debug turnkey.d/grub-iface-naming turnkey.d/hostname turnkey.d/locale turnkey.d/lvm-no-boot turnkey.d/monit turnkey.d/motd turnkey.d/persistent-net turnkey.d/roothome turnkey.d/rootpass turnkey.d/sshd turnkey.d/sslcert turnkey.d/stunnel turnkey.d/sysctl turnkey.d/usr-local-root turnkey.d/vim.tiny turnkey.d/zz-ssl-ciphers
